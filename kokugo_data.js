...
window.KOKUGO_PROBLEMS = [
  ...
  { id: "g-0049", unit: "辞書の使い方", question: "漢字辞典で、読み方も部首もわからないが画数だけわかる時に使うさくいんは？",
    answer: "総画さくいん", distractors: ["音訓さくいん", "部首さくいん"], explanation: "画数の数から探すのは総画さくいん" },
  { id: "g-0050", unit: "辞書の使い方", question: "国語辞典で先に出てくるのはどっち？「かき」と「かぎ」",
    answer: "かき", distractors: ["かぎ", "同じところに出てくる"], explanation: "にごらない音（清音）はにごる音（濁音）より先にならぶ" },
